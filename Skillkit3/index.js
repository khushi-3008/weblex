...
const ShowDogPictureIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        // let speechOutput = `You said the number ${dogPictureNumber}`;
        ...
        var params = {
          ...
          Item: {
            'pictureid' : {N:'0'},
            'pictureToShow' : {S:dogPictureNumber}
          }
        };
        var speechOutput = `You said the number ${dogPictureNumber}`;
        ddb.putItem(params, function(err, data) {
          if (err) {
              speechOutput = `Fail`;
            console.log("Error", err);
...
const ShowAllDogPicturesIntentHandler = {
    ...
    async handle(handlerInput) {
        let speechOutput = `You ask for all dogs`;
